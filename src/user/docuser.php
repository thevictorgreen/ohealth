...
<head>
    ...
    //General application state globals
    var leftNav;
    var appForm;
    var patForm;
    var preForm;
    ...
    //Chart application state globals
    var chartNav;
    var chartForm;

    //User environment globals
    var uname;
    var api_key;
   ...
   function route_pharmacy(patlat,patlng,phlat,phlng) {//{[18]}
    ...
    function state_general() { //{[6]}
        ...
        appForm = leftNav.cells("a1").attachForm();
        patForm = leftNav.cells("b1").attachForm();
        preForm = leftNav.cells("c1").attachForm();
        repForm = leftNav.cells("d1").attachForm();
        ...
        appForm.attachEvent("onButtonClick",function(id){ //{[7]}
        ...
        patForm.attachEvent("onButtonClick",function(id){ //{[9]}

           if (id == "viewPat") {//{[10]}

               if (perm.viewPatients == "true") {//{[11]}
                   ...
                   editUserForm.attachEvent("onButtonClick",function(id) {//{[12]}
                   ...
                   userTools.attachEvent("onClick",function(id){//{[14]}
                      ...
                      if (id == "userAdd") {//{[15]}
                         ...
                         var addUserForm = popLayout.cells("a").attachForm(addUserFormData);

                         addUserForm.attachEvent("onButtonClick",function(id){//{[16]}
        ...
        preForm.attachEvent("onButtonClick",function(id){//{[21]}
    ...
    dhtmlxEvent(window,"load",function(){ //BEGIN dhtmlxEvent Function {[1]}
       ...
       lgForm.attachEvent("onButtonClick",function(id) {//BEGIN lgForm.attachEvent {[2]}

           if (id == "submit") {//BEGIN if id == submit {[3]}

               uname = lgForm.getItemValue("uname");
               var upass = lgForm.getItemValue("pass");

               dhtmlxAjax.get("auth/authenticate.php?uname="+uname+"&upass="+upass,function(loader) {//BEGIN dhtmlxAjax {[4]}

                   if (loader.xmlDoc.responseText == "authenticated") { //{[5]}
       ...
       });//END lgForm.attachEvent {[2]}

       initializeViewMap();
       state_general();

    }); //END dhtmlxEvent Function {[1]}
