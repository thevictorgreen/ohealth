<?php
  ...
  $query = "SELECT al_id,d_id,AES_DECRYPT(d_name,'$tde_key') as d_name FROM $dr_allergies WHERE pt_id = $pt_id";
  ...
  while ($row = mysql_fetch_array($result)) {
        ...
        echo "<al_id>"  . $row['al_id']  . "</al_id>";
        echo "<d_id>"   . $row['d_id']   . "</d_id>";
        echo "<d_name>" . $row['d_name'] . "</d_name>";
