<?php
  ...
  $query = "INSERT INTO $dr_diagnosis ( pt_id,code,descr,d_type,diag_date,u_id ) VALUES ( $pt_id,AES_ENCRYPT('$code','$tde_key'),AES_ENCRYPT('$descr','$tde_key'),AES_ENCRYPT('$d_type','$tde_key'),CURDATE(),$u_id )";
  mysql_query($query);


  echo "<message>DIAGNOSIS ADDED</message>";
