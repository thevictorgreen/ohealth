<?php
  ...
  $query = "SELECT diag_id,AES_DECRYPT(code,'$tde_key') as code,AES_DECRYPT(descr,'$tde_key') as descr,diag_date,u_id FROM $dr_diagnosis WHERE pt_id = $pt_id and AES_DECRYPT(d_type,'$tde_key') = 'Acute'";
