<?php
  ...
  //mysql_query("UPDATE $s_table SET ht='$ht', wt='$wt', bmi='$bmi', bpmm='$bpmm', bphg='$bphg', temp='$temp', pulse='$pulse', resp='$resp', cc='$cc', s='$s', o='$o', p='$p' WHERE soap_id = $soap_id");
  $query = "UPDATE $dr_soap SET
                               ht    = AES_ENCRYPT('$ht','$tde_key'),
                               wt    = AES_ENCRYPT('$wt','$tde_key'),
                               bmi   = AES_ENCRYPT('$bmi','$tde_key'),
                               bpmm  = AES_ENCRYPT('$bpmm','$tde_key'),
                               bphg  = AES_ENCRYPT('$bphg','$tde_key'),
                               temp  = AES_ENCRYPT('$temp','$tde_key'),
                               pulse = AES_ENCRYPT('$pulse','$tde_key'),
                               resp  = AES_ENCRYPT('$resp','$tde_key'),
                               cc    = AES_ENCRYPT('$cc','$tde_key'),
                               s     = AES_ENCRYPT('$s','$tde_key'),
                               o     = AES_ENCRYPT('$o','$tde_key'),
                               p     = AES_ENCRYPT('$p','$tde_key')
                               WHERE soap_id = $soap_id";
  ...
  echo "<message>NOTE UPDATED</message>";
