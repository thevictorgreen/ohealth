<?php
        ...
        if ($data->is_select_mode()) {
            ...
            $data->render_sql("select $dr_patients.ins_id,gl_insurance.name as name,AES_DECRYPT($dr_patients.ins_mri,'$tde_key') as ins_mri,AES_DECRYPT($dr_patients.ins_grp,'$tde_key') as ins_grp FROM $dr_patients,gl_insurance where $dr_patients.id = $id and $dr_patients.ins_id = gl_insurance.ins_id","ins_id","ins_id,name,ins_mri,ins_grp");
        }
