<?php
  ...
  $result = mysql_query("SELECT name,addr,city,state,zip,phone,dr_patients,dr_users,dr_prescriptions_que,api_key from gl_droffice where id = 1");
